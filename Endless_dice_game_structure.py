...
def player1():
    ...
    random_dice_label["text"]="Player 1 rice random number :" + str(random_no)
    ...
    def player2():
        ...
        random_dice_label["text"]="Player 2 rice random number :" + str(random_no)
        player2_score=player2_score + random_no2
        playe21_label["text"] = str(player2_score)
